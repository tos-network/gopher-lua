...
func TestBuildIRFromTOLRejectsReservedFunctionNameSelector(t *testing.T) {
	src := []byte(`
tol 0.2
contract Demo {
  fn selector() public {
...
func TestBuildIRFromTOLRejectsReservedEventNameSelector(t *testing.T) {
	src := []byte(`
tol 0.2
contract Demo {
  event selector(a: u256)
}
`)
	_, err := BuildIRFromTOL(src, "<tol>")
	if err == nil {
...
func TestBuildIRFromTOLRejectsAssertNonStringMessageArg(t *testing.T) {
	src := []byte(`
tol 0.2
contract Demo {
  fn run() public {
...
func TestCompileTOLToBytecodeSelectorBuiltinRejectsMalformedArgListLiteralArg(t *testing.T) {
	src := []byte(`
tol 0.2
contract Demo {
  fn bad() public {
...
func TestCompileTOLToBytecodeSelectorBuiltinRejectsInvalidFunctionNameLiteralArg(t *testing.T) {
	src := []byte(`
tol 0.2
contract Demo {
  fn bad() public {
